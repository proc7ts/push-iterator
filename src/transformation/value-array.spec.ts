...
describe('valueArray', () => {
  it('values elements', () => {
    expect([...valueArray([11, 22, 33], element => element > 11 && element + 100)]).toEqual([
      122, 133,
    ]);
    expect([...valueArray([11, 22, 33], element => (element > 11 ? element + 100 : null))]).toEqual(
      [122, 133],
    );
  });
  it('pushes element values', () => {
    expect(itsElements(valueArray([11, 22, 33], element => element > 11 && element + 100))).toEqual(
      [122, 133],
    );
    expect(
      itsElements(valueArray([11, 22, 33], element => (element > 11 ? element + 100 : null))),
    ).toEqual([122, 133]);
  });
