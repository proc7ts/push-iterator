...
describe('mapIt', () => {
  describe('over raw iterable', () => {
    it('converts elements', () => {
      expect([...mapIt(new Set([11, 22, 33]), element => `${element}!`)]).toEqual([
        '11!',
        '22!',
        '33!',
      ]);
    ...
    it('pushes converted elements', () => {
      expect(itsElements(mapIt(new Set([11, 22, 33]), element => `${element}!`))).toEqual([
        '11!',
        '22!',
        '33!',
      ]);
  ...
  describe('over push iterable', () => {
    it('converts elements', () => {
      expect([...mapIt(overMany(11, 22, 33), element => `${element}!`)]).toEqual([
        '11!',
        '22!',
        '33!',
      ]);
      expect(itsElements(mapIt(overMany(11, 22, 33), element => `${element}!`))).toEqual([
        '11!',
        '22!',
        '33!',
      ]);
